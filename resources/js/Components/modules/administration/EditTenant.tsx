...
type FormData = yup.InferType<typeof EditTenantSchema>;

export const EditTenant = React.memo((props: IProps) => {
    ...
    async function onSubmit(form: FormData) {
        try {
            setPending(true);
            await api.patch("api/v1/modules/administration/tenants/" + props.selection.id, form);
            enqueueSnackbar("Gerente atualizado com sucesso!", { variant: "success" });
            setTimeout(() => {
                setOpen(false);
