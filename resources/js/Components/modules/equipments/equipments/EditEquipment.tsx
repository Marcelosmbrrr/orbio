...
import { EditEquipmentSchema } from './schemas/EditEquipmentSchema';
...
type FormData = yup.InferType<typeof EditEquipmentSchema>;

export const EditEquipment = React.memo((props: IProps) => {
    ...
    async function onSubmit(form: FormData) {
        ...
        try {
            setPending(true);
            await api.post("api/v1/modules/equipments/" + props.selection.id, _form, {
                headers: {
