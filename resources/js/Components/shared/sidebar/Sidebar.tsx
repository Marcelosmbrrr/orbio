...
export function Sidebar() {
    ...
    function optionStyle(path: string[]) {
        return path.includes(url) ?
            'flex items-center p-2 text-gray-900 bg-gray-100 dark:bg-gray-700 rounded-lg dark:text-white hover:bg-gray-100' :
            ...
            <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-52 shadow h-screen transition-transform -translate-x-full lg:translate-x-0">
                <div className="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">
                    <ul className="space-y-2 font-medium">
                        ...
                        {!!user?.modules.ge.read &&
                            <li className='group'>
                                ...
                                <ul className="hidden group-hover:block py-2 space-y-2">
                                    <li>
                                        <Link href="drones" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400">
                                    ...
                                    <li>
                                        <Link href="batteries" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                    ...
                                    <li>
                                        <Link href="equipments" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" >
                        ...
                        <li>
                            <div onClick={() => signOut()} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
